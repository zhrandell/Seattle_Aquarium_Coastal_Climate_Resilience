...
* To view a copy of _Waksa·s_' divelog, see the _DiveLog_ document ([Excel](https://github.com/zhrandell/Seattle_Aquarium_ROV_development/blob/main/documents/DiveLog.xlsx))
